...
export default function LandingPage() {
  return (
    <section className="flex flex-1 flex-col justify-center text-center sm:text-left">
      ...
      <Link
        href="/quiz/1"
        className="inline-flex items-center justify-center gap-2 self-center sm:self-start rounded-full bg-ink hover:bg-black text-white px-8 py-4 text-base font-medium transition-colors shadow-sm"
      >
